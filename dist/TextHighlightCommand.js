...
var TextHighlightCommand = function (_UICommand) {
  (0, _inherits3.default)(TextHighlightCommand, _UICommand);

  function TextHighlightCommand() {
    var _ref;

    var _temp, _this, _ret;

    (0, _classCallCheck3.default)(this, TextHighlightCommand);
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = TextHighlightCommand.__proto__ || (0, _getPrototypeOf2.default)(TextHighlightCommand)).call.apply(_ref, [this].concat(args))), _this), _this._popUp = null, _this.isEnabled = function (state) {
      return (0, _isTextStyleMarkCommandEnabled2.default)(state, _MarkNames.MARK_TEXT_HIGHLIGHT);
      ...
      var hex = result ? result.mark.attrs.highlightColor : null;
  ...
  return TextHighlightCommand;
}(_UICommand3.default);

exports.default = TextHighlightCommand;