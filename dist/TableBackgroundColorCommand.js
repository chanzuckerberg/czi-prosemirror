...
var TableBackgroundColorCommand = function (_UICommand) {
  (0, _inherits3.default)(TableBackgroundColorCommand, _UICommand);
  ...
  function TableBackgroundColorCommand() {
    ...
    (0, _classCallCheck3.default)(this, TableBackgroundColorCommand);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = TableBackgroundColorCommand.__proto__ || (0, _getPrototypeOf2.default)(TableBackgroundColorCommand)).call.apply(_ref, [this].concat(args))), _this), _this._popUp = null, _this.shouldRespondToUIEvent = function (e) {
  ...
  (0, _createClass3.default)(TableBackgroundColorCommand, [{
    key: 'cancel',
    value: function cancel() {
      this._popUp && this._popUp.close(undefined);
    }
  }]);
  return TableBackgroundColorCommand;
}(_UICommand3.default);

exports.default = TableBackgroundColorCommand;