...
var VALID_MATH_MARK_NAMES = new _set2.default([_MarkNames.MARK_FONT_SIZE, _MarkNames.MARK_TEXT_COLOR]);
...
function isTextStyleMarkCommandEnabled(state, markName) {
  ...
  if (mathNodeType && VALID_MATH_MARK_NAMES.has(markName) && (0, _isNodeSelectionForNodeType2.default)(selection, mathNodeType)) {
